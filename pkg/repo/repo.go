...
||||||| parent of 4aab8cd (tuf repo / secret are now created, but I'm not sure why the fileserver is no worky.)
=======
// Copyright 2022 The Sigstore Authors
//
// Licensed under the Apache License, Version 2.0 (the "License");
...
>>>>>>> 4aab8cd (tuf repo / secret are now created, but I'm not sure why the fileserver is no worky.)
